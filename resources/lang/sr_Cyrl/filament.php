...
return [
    ...
    'properties' => [
        ...
        'fields' => [
            ...
            'address' => 'Адреса',
            'city' => 'Град',
            'public' => 'Непокретност је видљива јавно',
            'country' => 'Земља',
    ...
    'charges' => [
        ...
        'fields' => [
            ...
            'status' => 'Статус',
            'receipt' => 'Рачун',
            'remaining_balance' => 'Преостало',
            'utility_type' => 'Врста комуналије',
        ],
        'actions' => [
        ...
        'utilities' => [
            ...
            'internet'    => 'Интернет',
            'heating'     => 'Грејање',
            'cooling'     => 'Хлађење / Клима',
            'tv'          => 'ТВ / Кабловска',
            'trash'       => 'Смеће / Одвоз',
            'phone'       => 'Телефон',
            'other'       => 'Остале комуналије',
        ],
        'status' => [
            'pending' => 'На чекању',
            'paid' => 'Плаћено',
