<x-filament-breezy::grid-section
    md="2"
    :title="__('filament-breezy::default.profile.2fa.title')"
                    ...
                    <div class="px-4 space-y-3">
                        ...
                        <div>
                            @foreach ($this->recoveryCodes->toArray() as $code)
                                <span
                                    class="inline-flex items-center p-1 text-xs font-medium text-gray-800 dark:text-gray-400 bg-gray-100 rounded-full dark:bg-gray-900"
                                >
                                    {{ $code }}
                                </span>
                            @endforeach
                        ...
                        <div class="inline-block text-xs">
                            <x-filament-breezy::clipboard-link
                                :data="$this->recoveryCodes->join(',')"
                            />
                        </div>
                    </div>
                @endif
