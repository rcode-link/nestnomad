        ...
        if ((t && typeof t == "object") || typeof t == "function")
            for (let i of wr(t))
                !Or.call(e, i) &&
                    ...
                    U(e, i, {
                        get: () => t[i],
                        enumerable: !(n = Er(t, i)) || n.enumerable,
                    });
        return e;
    };
var Rr = (e, t, r) => (
    ...
    Ar = (e) => ye(U({}, "__esModule", { value: !0 }), e);
var T = p((gi, be) => {
    be.exports = qr;
    ...
    function qr() {
        for (var e = {}, t = 0; t < arguments.length; t++) {
            var r = arguments[t];
            for (var n in r) Cr.call(r, n) && (e[n] = r[n]);
        }
        return e;
    }
});
var Ee = p((_e, xe) => {
    (function () {
        var e = this,
            t = {};
        typeof _e < "u" ? (xe.exports = t) : (e.fuzzy = t),
            (t.simpleFilter = function (r, n) {
                return n.filter(function (i) {
                    return t.test(r, i);
                });
            }),
            (t.test = function (r, n) {
                return t.match(r, n) !== null;
            }),
            (t.match = function (r, n, i) {
                i = i || {};
                var s = 0,
                    o = [],
                    u = n.length,
                    ...
                    d = i.pre || "",
                    h = i.post || "",
                    l = (i.caseSensitive && n) || n.toLowerCase(),
                    g;
            ...
            (t.filter = function (r, n, i) {
                return !n || n.length === 0
                    ...
                    : typeof r != "string"
                      ...
                      : ((i = i || {}),
                        n
                            .reduce(function (s, o, u, a) {
                                var c = o;
                                i.extract && (c = i.extract(o));
                                var d = t.match(r, c, i);
                                return (
                                    d != null &&
                                        (s[s.length] = {
                            ...
                            .sort(function (s, o) {
                                var u = o.score - s.score;
                                return u || s.index - o.index;
                            }));
            });
    })();
});
var Le = p((mi, we) => {
    ...
    O.prototype.drawItem = function (e, t) {
        var r = document.createElement("li"),
            n = document.createElement("a");
        t && (r.className += " active"),
            (n.innerHTML = e.string),
            r.appendChild(n),
    ...
    O.prototype.handleMouseUp = function (e) {
        (this.selectingListItem = !1),
    ...
    O.prototype.drawError = function (e) {
...
var Se = p((vi, Oe) => {
    ...
    _.prototype.handleKeyUp = function (e) {
        e === 40 ||
            e === 38 ||
            e === 27 ||
            e === 13 ||
    ...
    _.prototype.handleKeyDown = function (e) {
        switch (e.keyCode) {
            case 13:
            case 9:
                this.list.isEmpty() ||
    ...
    _.prototype.handleBlur = function () {
        !this.list.selectingListItem &&
            this.options.hideOnBlur &&
            this.list.hide();
    };
    _.prototype.handlePaste = function (e) {
        if (e.clipboardData)
    ...
    _.prototype.handleInputChange = function (e) {
        if (
        ...
        this.getCandidates(
            function (t) {
                for (
                    var r = 0;
                    r < t.length &&
                    (this.list.add(t[r]), r !== this.options.limit - 1);
                    r++
                );
                this.list.draw();
            }.bind(this),
    ...
    _.prototype.handleFocus = function () {
    ...
    _.prototype.getCandidates = function (e) {
        var t = {
                pre: "<strong>",
                post: "</strong>",
                extract: function (n) {
            ...
            r;
        this.options.filter
            ? ((r = Ir.filter(this.query, this.data, t)),
              (r = r.map(
                  function (n) {
                      return {
                          original: n.original,
            ...
            : (r = this.data.map(
                  function (n) {
                      var i = this.render(n);
                      return { original: n, string: i };
                  }.bind(this),
              )),
            e(r);
    };
    _.prototype.getItemValue = function (e) {
        return e;
    };
    _.prototype.render = function (e, t) {
        ...
        for (
            ...
            (r =
                ...
                "</strong>" +
                r.slice(s)),
                (i = n.slice(0, i).lastIndexOf(this.query));
        }
        return r;
    };
    _.prototype.renderError = function (e) {
...
var Ce = p((yi, Ae) => {
    ...
    var Re = Se();
    Ae.exports = Re;
    typeof window < "u" && (window.Suggestions = Re);
});
var Te = p((bi, Ie) => {
    var Pr = "Expected a function",
        ...
        Fr =
            ...
            global,
        Dr = typeof self == "object" && self && self.Object === Object && self,
        Vr = Fr || Dr || Function("return this")(),
        Ur = Object.prototype,
        Kr = Ur.toString,
        Hr = Math.max,
        Qr = Math.min,
    ...
    function Wr(e, t, r) {
        ...
        (t = ke(t) || 0),
            ee(r) &&
                ((d = !!r.leading),
                (h = "maxWait" in r),
                (s = h ? Hr(ke(r.maxWait) || 0, t) : s),
                (l = "trailing" in r ? !!r.trailing : l));
        function g(y) {
            var C = n,
                z = i;
            return (n = i = void 0), (c = y), (o = e.apply(z, C)), o;
        }
        function b(y) {
            return (c = y), (u = setTimeout(S, t)), d ? g(y) : o;
        }
        function E(y) {
            var C = y - a,
                z = y - c,
                me = t - C;
            return h ? Qr(me, s - z) : me;
        }
        function R(y) {
            var C = y - a,
                z = y - c;
            return a === void 0 || C >= t || C < 0 || (h && z >= s);
        }
        function S() {
            var y = Y();
            if (R(y)) return A(y);
        ...
        function A(y) {
            return (u = void 0), l && n ? g(y) : ((n = i = void 0), o);
        }
        function ge() {
            u !== void 0 && clearTimeout(u), (c = 0), (n = a = i = u = void 0);
        }
        function L() {
            return u === void 0 ? o : A(Y());
        }
        function G() {
            var y = Y(),
                C = R(y);
            if (((n = arguments), (i = this), (a = y), C)) {
                if (u === void 0) return b(a);
                if (h) return (u = setTimeout(S, t)), g(a);
            }
            return u === void 0 && (u = setTimeout(S, t)), o;
        }
        return (G.cancel = ge), (G.flush = L), G;
    }
    function ee(e) {
        var t = typeof e;
    ...
    function $r(e) {
        return typeof e == "symbol" || (Zr(e) && Kr.call(e) == Mr);
    }
    function ke(e) {
...
var Ue = p((_i, te) => {
    ...
    m.prototype.emit = function (t) {
        ...
        if (typeof a == "function") Pe(a, this, r);
        else
            for (var c = a.length, d = De(a, c), n = 0; n < c; ++n)
                Pe(d[n], this, r);
        return !0;
    };
    function je(e, t, r, n) {
    ...
    m.prototype.once = function (t, r) {
        return H(r), this.on(t, Ge(this, t, r)), this;
    };
    m.prototype.prependOnceListener = function (t, r) {
        return H(r), this.prependListener(t, Ge(this, t, r)), this;
    };
    m.prototype.removeListener = function (t, r) {
        var n, i, s, o, u;
        if ((H(r), (i = this._events), i === void 0)) return this;
        ...
        if (n === r || n.listener === r)
            ...
            s === 0 ? n.shift() : Yr(n, s),
                ...
                i.removeListener !== void 0 &&
                    this.emit("removeListener", t, u || r);
        }
        return this;
    };
    ...
    function tn(e, t) {
        return new Promise(function (r, n) {
            ...
            Ve(e, t, s, { once: !0 }), t !== "error" && rn(e, i, { once: !0 });
        });
    }
    function rn(e, t, r) {
        typeof e.on == "function" && Ve(e, "error", t, r);
    }
    function Ve(e, t, r, n) {
...
var We = p((Ei, Qe) => {
    ...
    function on(e) {
        ...
        return i ? { url: r, rel: i, params: s } : null;
    }
    function sn(e) {
        return e
            ? e.split(/,\s*</).reduce(function (t, r) {
                  var n = on(r);
                  if (!n) return t;
                  var i = n.rel.split(/\s+/);
                  return (
                      i.forEach(function (s) {
                          t[s] || (t[s] = { url: n.url, params: n.params });
                      }),
                      t
                  );
              }, {})
...
var $e = p((wi, Ze) => {
    ...
    function re(e, t) {
        ...
        this.links = an(this.headers.link);
    }
    re.prototype.hasNextPage = function () {
        ...
        n ||
            (typeof r == "string"
                ...
                : r && typeof r.message == "string"
                  ? (n = r.message)
                  : t === Je.ERROR_REQUEST_ABORTED && (n = "Request aborted")),
            (this.message = n),
            (this.type = t),
...
var rt = p((Si, tt) => {
    ...
    function ln(e) {
        var t = e.indexOf(":"),
            r = e.substring(0, t).trim().toLowerCase(),
            n = e.substring(t + 1).trim();
...
var ut = p((Ri, at) => {
    ...
    function fn(e) {
        var t = Q[e.id];
        t && (t.abort(), delete Q[e.id]);
    }
    function pn(e, t) {
        return new hn(e, {
            body: t.response,
            headers: dn(t.getAllResponseHeaders()),
            statusCode: t.status,
        });
    }
    function it(e) {
        var t = e.total,
            r = e.loaded,
            n = (100 * r) / t;
        return { total: t, transferred: r, percent: n };
    }
    function ot(e, t) {
        return new Promise(function (r, n) {
            t.onprogress = function (o) {
                e.emitter.emit(ne.EVENT_PROGRESS_DOWNLOAD, it(o));
            };
            var i = e.file;
            i &&
                (t.upload.onprogress = function (o) {
                    e.emitter.emit(ne.EVENT_PROGRESS_UPLOAD, it(o));
                }),
                ...
                (t.onabort = function () {
                    var o = new nt({
                        request: e,
                        type: ne.ERROR_REQUEST_ABORTED,
                    });
                    n(o);
                }),
                (t.onload = function () {
                    if ((delete Q[e.id], t.status < 200 || t.status >= 400)) {
                        var o = new nt({
                            request: e,
                            body: t.response,
                            statusCode: t.status,
    ...
    function gn(e) {
        return Promise.resolve().then(function () {
            var t = st(e, e.client.accessToken);
            return ot(e, t);
        });
    }
    at.exports = {
...
var lt = p((W, D) => {
    (function (e) {
        var t = typeof W == "object" && W,
            r = typeof D == "object" && D && D.exports == t && D,
        ...
        var s = function (l) {
            ...
            u = /[\t\n\f\r ]/g,
            a = function (l) {
                l = String(l).replace(u, "");
                var g = l.length;
                g % 4 == 0 && ((l = l.replace(/==?$/, "")), (g = l.length)),
                    (g % 4 == 1 || /[^+a-zA-Z0-9/]/.test(l)) &&
                        s(
                            "Invalid character: the string to be decoded is not correctly encoded.",
                        );
                for (var b = 0, E, R, S = "", A = -1; ++A < g; )
                    (R = o.indexOf(l.charAt(A))),
                        (E = b % 4 ? E * 64 + R : R),
                        b++ % 4 &&
            ...
            d = { encode: c, decode: a, version: "0.1.0" };
        if (
            ...
            if (r) r.exports = d;
            else for (var h in d) d.hasOwnProperty(h) && (t[h] = d[h]);
        else e.base64 = d;
    })(W);
});
var oe = p((Ai, ct) => {
    ...
    function vn(e) {
        ...
        var i = yn(n),
            s = { usage: r, user: i.u };
        return (
            P(i, "a") && (s.authorization = i.a),
            P(i, "exp") && (s.expires = i.exp * 1e3),
            P(i, "iat") && (s.created = i.iat * 1e3),
            P(i, "scopes") && (s.scopes = i.scopes),
            P(i, "client") && (s.client = i.client),
            P(i, "ll") && (s.lastLogin = i.ll),
            P(i, "iu") && (s.impersonator = i.iu),
            (ie[e] = s),
            s
        );
    }
...
var dt = p((Ci, se) => {
    ...
    function V() {}
    Object.create &&
        ((V.prototype = Object.create(null)), new V().__proto__ || (w = !1));
    function _n(e, t, r) {
    ...
    function Z(e, t) {
        --e._eventsCount === 0 ? (e._events = new V()) : delete e._events[t];
    }
    function x() {
    ...
    x.prototype.eventNames = function () {
        ...
        for (n in (r = this._events))
            bn.call(r, n) && t.push(w ? n.slice(1) : n);
    ...
    x.prototype.emit = function (t, r, n, i, s, o) {
        var u = w ? w + t : t;
        ...
        if (a.fn) {
            switch ((a.once && this.removeListener(t, a.fn, void 0, !0), c)) {
                ...
                case 5:
                    return a.fn.call(a.context, r, n, i, s), !0;
                case 6:
                    return a.fn.call(a.context, r, n, i, s, o), !0;
            }
            for (h = 1, d = new Array(c - 1); h < c; h++)
                d[h - 1] = arguments[h];
            ...
            for (h = 0; h < l; h++)
                switch (
                    (a[h].once && this.removeListener(t, a[h].fn, void 0, !0),
                    c)
                ) {
                    case 1:
                        ...
                        break;
                    case 2:
                        a[h].fn.call(a[h].context, r);
                        break;
                    case 3:
                        a[h].fn.call(a[h].context, r, n);
                        break;
                    case 4:
                        a[h].fn.call(a[h].context, r, n, i);
                        break;
                    default:
                        if (!d)
                            for (g = 1, d = new Array(c - 1); g < c; g++)
                                d[g - 1] = arguments[g];
                        a[h].fn.apply(a[h].context, d);
                }
        }
        return !0;
    };
    x.prototype.on = function (t, r, n) {
        return ht(this, t, r, n, !1);
    };
    x.prototype.once = function (t, r, n) {
        return ht(this, t, r, n, !0);
    };
    x.prototype.removeListener = function (t, r, n, i) {
        var s = w ? w + t : t;
        if (!this._events[s]) return this;
        if (!r) return Z(this, s), this;
        ...
        if (o.fn)
            ...
            for (var u = 0, a = [], c = o.length; u < c; u++)
                (o[u].fn !== r ||
                    (i && !o[u].once) ||
                    (n && o[u].context !== n)) &&
                    a.push(o[u]);
    ...
    x.prototype.removeAllListeners = function (t) {
        ...
        return (
            t
                ? ((r = w ? w + t : t), this._events[r] && Z(this, r))
                : ((this._events = new V()), (this._eventsCount = 0)),
            this
        );
    };
...
var mt = p((qi, gt) => {
    ...
    function ft(e) {
        return Array.isArray(e) ? xn(e) : encodeURIComponent(String(e));
    }
    function pt(e, t, r) {
        if (r === !1 || r === null) return e;
        var n = /\?/.test(e) ? "&" : "?",
            i = encodeURIComponent(t);
        return (
            r !== void 0 && r !== "" && r !== !0 && (i += "=" + ft(r)),
            "" + e + n + i
        );
    }
    function En(e, t) {
    ...
    function wn(e, t) {
        if (!t || e.slice(0, 4) === "http") return e;
        var r = e[0] === "/" ? "" : "/";
        return "" + t.replace(/\/$/, "") + r + e;
    }
    function Ln(e, t) {
        return t
            ? e.replace(/\/:([a-zA-Z0-9]+)/g, function (r, n) {
                  var i = t[n];
                  if (i === void 0)
    ...
    gt.exports = {
        appendQueryObject: En,
        appendQueryParam: pt,
        prependOrigin: wn,
        interpolateRouteParams: Ln,
    };
});
var bt = p((ki, yt) => {
    "use strict";
    ...
    function q(e, t) {
        ...
        var r = {};
        t.body && (r["content-type"] = "application/json");
        var n = ae(r, t.headers),
            i = Object.keys(n).reduce(function (s, o) {
                return (s[o.toLowerCase()] = n[o]), s;
            }, {});
        (this.id = Rn++),
            (this._options = t),
            (this.emitter = new Sn()),
    ...
    q.prototype.url = function (t) {
        var r = $.prependOrigin(this.path, this.origin);
        r = $.appendQueryObject(r, this.query);
        var n = this.params,
            i = t ?? this.client.accessToken;
        if (i) {
            r = $.appendQueryParam(r, "access_token", i);
            var s = On(i).user;
            n = ae({ ownerId: s }, n);
        }
        return (r = $.interpolateRouteParams(r, n)), r;
    };
        ...
        return (
            ...
            t.client.sendRequest(t).then(
                function (r) {
                    return (
                        (t.response = r),
                        t.emitter.emit(vt.EVENT_RESPONSE, r),
                        r
                    );
                },
                function (r) {
                    throw ((t.error = r), t.emitter.emit(vt.EVENT_ERROR, r), r);
                },
            )
        );
    };
    q.prototype.abort = function () {
        this._nextPageRequest &&
            ...
            !(this.response || this.error || this.aborted) &&
                ((this.aborted = !0), this.client.abortRequest(this));
    };
    q.prototype.eachPage = function (t) {
        var r = this;
        function n(o) {
            function u() {
                delete r._nextPageRequest;
                var a = o.nextPage();
                a && ((r._nextPageRequest = a), s(a));
            }
            t(null, o, u);
        }
        function i(o) {
    ...
    q.prototype._extend = function (t) {
        var r = ae(this._options, t);
        return new q(this.client, r);
    };
    yt.exports = q;
});
var ue = p((Ii, xt) => {
    ...
    function _t(e) {
        ...
        An(e.accessToken),
            ...
            (this.origin = e.origin || qn.API_ORIGIN);
    }
    _t.prototype.createRequest = function (t) {
...
var le = p((Ti, Lt) => {
    ...
    B.prototype = Object.create(wt.prototype);
    B.prototype.constructor = B;
    B.prototype.sendRequest = Et.browserSend;
    B.prototype.abortRequest = Et.browserAbort;
    function kn(e) {
        return new B(e);
    }
    Lt.exports = kn;
...
var Pt = p((Ni, Tt) => {
  ...
  `,
        ...
        return (
            ...
            function (r) {
                ...
                if (n) {
                    var i = he(n, t);
                    throw (
                        (t.apiName && (i = t.apiName + ": " + i), new Error(i))
                    );
                }
            }
        );
    ...
    v.shape = function (t) {
        var r = Gn(t);
        return function (i) {
            var s = k(v.plainObject, i);
            if (s) return s;
            for (var o, u, a = [], c = 0; c < r.length; c++)
                (o = r[c].key),
                    (u = r[c].value),
                    (s = k(u, i[o])),
                    s && a.push([o].concat(s));
...
`,
    ...
    v.strictShape = function (t) {
        ...
        return function (i) {
            var s = r(i);
            if (s) return s;
            var o = Object.keys(i).reduce(function (u, a) {
                return t[a] === void 0 && u.push(a), u;
            }, []);
            if (o.length !== 0)
                return function () {
    ...
    v.equal = function (t) {
        return function (n) {
            if (n !== t) return JSON.stringify(t);
        };
    };
    v.oneOf = function () {
        var t = Array.isArray(arguments[0])
        ...
        return v.oneOfType.apply(this, r);
    };
    v.range = function (t) {
        var r = t[0],
            n = t[1];
        return function (s) {
            var o = k(v.number, s);
            if (o || s < r || s > n)
                return "number between " + r + " & " + n + " (inclusive)";
        };
    };
    v.any = function () {};
    ...
    function k(e, t) {
        if (!(t == null && !e.hasOwnProperty("__required"))) {
            var r = e(t);
    ...
    function he(e, t) {
        ...
        return (
            i.length === 0 && (i = [Ct]),
            (t = Mn(t, { path: i })),
            typeof n == "function" ? n(t) : kt(t, Bn(n))
        );
    }
    function Nn(e) {
        return e.length < 2
...
var Nt = p((Bi, Mt) => {
    ...
    function Fn(e) {
        if (typeof window < "u")
            return e instanceof global.Blob || e instanceof global.ArrayBuffer
                ? void 0
                : "Blob or ArrayBuffer";
    ...
    function Dn(e, t) {
        return j.assert(j.strictShape(e), t);
    }
    function Vn(e) {
        var t = "date";
        ...
        try {
            var r = new Date(e);
            if (r.getTime && isNaN(r.getTime())) return t;
        } catch {
            return t;
        }
    }
    function Un(e) {
        return j.tuple(j.number, j.number)(e);
    }
    Mt.exports = zn(j, {
        file: Fn,
        date: Vn,
...
var Dt = p((zi, Ft) => {
    ...
    var Qn = zt();
    function Wn(e) {
        return Qn(e, function (t, r) {
            return typeof r == "boolean" ? JSON.stringify(r) : r;
        });
    }
    Ft.exports = Wn;
});
var Ut = p((Fi, Vt) => {
    ...
    function Xn(e) {
        return function (t) {
            var r;
            Zn.prototype.isPrototypeOf(t) ? (r = t) : (r = $n(t));
...
var Zt = p((Di, Wt) => {
    ...
    de.forwardGeocode = function (e) {
        f.assertShape({
            query: f.required(f.string),
            mode: f.oneOf("mapbox.places", "mapbox.places-permanent"),
            countries: f.arrayOf(f.string),
            proximity: f.oneOf(f.coordinates, "ip"),
            types: f.arrayOf(f.oneOf(Qt)),
            autocomplete: f.boolean,
            bbox: f.arrayOf(f.number),
            limit: f.number,
            language: f.arrayOf(f.string),
            routing: f.boolean,
            fuzzyMatch: f.boolean,
            worldview: f.string,
            session_token: f.string,
        })(e),
        ...
        return this.client.createRequest({
            ...
            params: X(e, ["mode", "query"]),
            query: t,
        });
    };
    de.reverseGeocode = function (e) {
        f.assertShape({
            query: f.required(f.coordinates),
            mode: f.oneOf("mapbox.places", "mapbox.places-permanent"),
            countries: f.arrayOf(f.string),
            types: f.arrayOf(f.oneOf(Qt)),
            bbox: f.arrayOf(f.number),
            limit: f.number,
            language: f.arrayOf(f.string),
            reverseMode: f.oneOf("distance", "score"),
            routing: f.boolean,
            worldview: f.string,
            session_token: f.string,
        })(e),
...
var Jt,
    ...
    tr = ve(() => {
        Xt();
        (Jt = (e) => crypto.getRandomValues(new Uint8Array(e))),
            (Yt = (e, t, r) => {
...
var ir = p((Ki, nr) => {
    ...
    rr.prototype = {
        select: function (e, t) {
            var r = this.getEventPayload("search.select", t, {
                selectedFeature: e,
            });
            if (
                r &&
                !(
                    (r.resultIndex === this.lastSentIndex &&
                        r.queryString === this.lastSentInput) ||
                    r.resultIndex == -1
                )
            )
                return (
                    (this.lastSentIndex = r.resultIndex),
        ...
        keyevent: function (e, t) {
            if (
                ...
                var r = this.getEventPayload("search.keystroke", t, {
                    key: e.key,
                });
                if (r) return this.push(r);
            }
        },
        send: function (e, t) {
            if (!this.enableEventLogging) return t ? t() : void 0;
            var r = this.getRequestOptions(e);
            this.request(
                r,
                function (n) {
        ...
        getEventPayload: function (e, t, r = {}) {
            if (
                (e === "search.select" && !r.selectedFeature) ||
                (e === "search.keystroke" && !r.key)
            )
                return null;
            var n;
            if (!t.options.proximity) n = null;
                ...
                var i = t._headers ? t._headers["ip-proximity"] : null;
                i && typeof i == "string"
                    ? (n = i.split(",").map(parseFloat))
                    : (n = [999, 999]);
            } else n = t.options.proximity;
            var s = t._map ? t._map.getZoom() : void 0,
                o = {
                    event: e,
            ...
            if (
                (e === "search.select"
                    ? (o.queryString = t.inputString)
                    : e != "search.select" && t._inputEl
                      ? (o.queryString = t._inputEl.value)
                      : (o.queryString = t.inputString),
                ["search.keystroke", "search.select"].includes(e) &&
                    (o.path = "geocoding/v5/mapbox.places"),
                e === "search.keystroke" && r.key)
            )
                o.lastAction = r.key;
            else if (e === "search.select" && r.selectedFeature) {
                var u = r.selectedFeature,
                    a = this.getSelectedIndex(u, t);
                if (
                    ((o.resultIndex = a),
                    (o.resultPlaceName = u.place_name),
                    (o.resultId = u.id),
                    u.properties && (o.resultMapboxId = u.properties.mapbox_id),
                    t._typeahead)
                ) {
                    var c = t._typeahead.data;
                    c &&
                        c.length > 0 &&
                        ((o.suggestionIds = this.getSuggestionIds(c)),
                        (o.suggestionNames = this.getSuggestionNames(c)),
                        (o.suggestionTypes = this.getSuggestionTypes(c)),
                        (o.suggestionSources = this.getSuggestionSources(c)));
                }
            }
            return this.validatePayload(o) ? o : null;
        },
        request: function (e, t) {
            ...
            (r.onreadystatechange = function () {
                ...
                r.open(e.method, e.host + "/" + e.path, !0);
        ...
        getEventSchemaVersion: function (e) {
            return ["search.keystroke", "search.select"].includes(e)
                ? "2.2"
                : "2.0";
        },
        validatePayload: function (e) {
            if (!e || !e.event) return !1;
            var t = ["event", "created", "sessionIdentifier", "queryString"],
                r = [
                    "event",
                    "created",
                    "sessionIdentifier",
                ...
                i = e.event;
            return i === "search.start"
                ? this.objectHasRequiredProps(e, t)
                : i === "search.keystroke"
                  ? this.objectHasRequiredProps(e, r)
                  : i === "search.select"
                    ? this.objectHasRequiredProps(e, n)
                    : !0;
        },
        objectHasRequiredProps: function (e, t) {
            return t.every(function (r) {
                return r === "queryString"
                    ? typeof e[r] == "string" && e[r].length > 0
                    : e[r] !== void 0;
            });
        },
        shouldEnableLogging: function (e) {
            return !(
                e.enableEventLogging === !1 ||
                (e.origin && e.origin !== "https://api.mapbox.com")
            );
        },
        flush: function () {
...
var sr = p((Hi, or) => {
    ...
    or.exports = { placeholder: ri };
});
var ur = p((ar, J) => {
    (function (e, t, r) {
        typeof J < "u" && J.exports ? (J.exports = r()) : (e[t] = r());
    })(ar, "subtag", function () {
        var e = "",
            t =
        ...
        function n(u) {
            return r(u).filter(function (a, c) {
                return a && c;
            });
        }
        function i(u) {
        ...
        function s(u, a, c) {
            Object.defineProperty(u, a, { value: c, enumerable: !0 });
        }
        function o(u, a, c) {
            function d(h) {
                return r(h)[u] || e;
            }
            s(d, "pattern", a), s(i, c, d);
        }
        return (
            o(1, /^[a-zA-Z]{2,3}$/, "language"),
            o(2, /^[a-zA-Z]{3}$/, "extlang"),
            o(3, /^[a-zA-Z]{4}$/, "script"),
            o(4, /^[a-zA-Z]{2}$|^[0-9]{3}$/, "region"),
            s(i, "split", n),
            i
        );
    });
...
var hr = p((Qi, cr) => {
    ...
    lr.prototype = {
        ...
        getCurrentPosition: function () {
            let e = { enableHighAccuracy: !0 };
            return new Promise(function (t, r) {
                window.navigator.geolocation.getCurrentPosition(t, r, e);
            });
        },
    };
    cr.exports = lr;
...
var pr = p((Wi, fr) => {
    function ni(e, t) {
        let r = dr(e),
            n = ["address", "street", "place", "country"];
        var i;
        if (typeof t == "function") return t(r);
        let s = n.indexOf(t);
        return (
            s === -1 ? (i = n) : (i = n.slice(s)),
            i.reduce(function (o, u) {
                return r[u] ? (o !== "" && (o = o + ", "), o + r[u]) : o;
            }, "")
        );
    }
    function dr(e) {
    ...
    fr.exports = {
        transformFeatureToGeolocationText: ni,
        getAddressInfo: dr,
        REVERSE_GEOCODE_COORD_RGX: ii,
    };
});
var br = p((Zi, yr) => {
    "use strict";
    var oi = Ce(),
        ...
        hi = hr(),
        mr = pr(),
        I = { FORWARD: 0, LOCAL: 1, REVERSE: 2 };
    function di() {
        var e = document.createElement("div");
        return (
            (e.className = "mapboxgl-ctrl-geocoder--powered-by"),
            (e.innerHTML =
    ...
    function vr(e) {
        (this._eventEmitter = new ai()),
            (this.options = M({}, this.options, e)),
            (this.inputString = ""),
            (this.fresh = !0),
            (this.lastSelected = null),
            (this.geolocation = new hi());
    }
    vr.prototype = {
        options: {
            zoom: 16,
        ...
        onAdd: function (e) {
            if (
                (e && typeof e != "string" && (this._map = e),
                this.setLanguage(),
                this.options.localGeocoderOnly ||
                    (this.geocoderService = pe(
                        fe({
            ...
            (this.eventManager = new ui(this.options)),
                ...
                (this._onSuggestionItemFocus =
                    this._onSuggestionItemFocus.bind(this)),
                (this._onSuggestionItemKeyDown =
                    this._onSuggestionItemKeydown.bind(this));
            var t = (this.container = document.createElement("div"));
            t.className = "mapboxgl-ctrl-geocoder mapboxgl-ctrl";
            var r = this.createIcon(
                "search",
            ...
            (this._inputEl = document.createElement("input")),
                ...
                this._inputEl.addEventListener(
                    "keyup",
                    function (l) {
                        this.eventManager.keyevent(l, this);
                    }.bind(this),
                );
            var n = document.createElement("div");
            n.classList.add("mapboxgl-ctrl-geocoder--pin-right"),
            ...
            if (
                ...
                this._geolocateEl.appendChild(s),
                    n.appendChild(this._geolocateEl),
                    this._showGeolocateButton();
            }
            var o = (this._typeahead = new oi(this._inputEl, [], {
                hideOnBlur: !this.options.useBrowserFocus,
                filter: !1,
                minLength: this.options.minLength,
                limit: this.options.limit,
            }));
            t.insertBefore(n, o.list.wrapper),
                this.setRenderFunction(this.options.render),
                (o.getItemValue = this.options.getItemValue);
            let u = this._typeahead.handleKeyDown.bind(this._typeahead),
                a = this._typeahead.handleKeyUp.bind(this._typeahead);
            this._typeahead.handleKeyUp,
                this.options.useBrowserFocus &&
                    ((this._typeahead.handleKeyDown = function (l) {
                        if (!(l.keyCode === 9 && !o.list.isEmpty())) {
                            if (l.keyCode === 40) {
                                (this._typeahead.list.active = 0),
                                    this._typeahead.list.element
                                        .querySelectorAll("li")
                                        .forEach(function (g) {
                                ...
                                (this._typeahead.list.active =
                                    ...
                                    this._typeahead.list.element
                                        .querySelectorAll("li")
                                        [this._typeahead.list.active].focus();
                                return;
                            }
                            u(l);
                        }
                    }.bind(this)),
                    (this._typeahead.handleKeyUp = function (l) {
                        if (l && l.keyCode === 16) {
                            l.preventDefault();
                            return;
                        }
            ...
            var c = o.list.draw,
                d = (this._footerNode = di()),
                h = this;
            return (
                (o.list.draw = function () {
                    h.options.useBrowserFocus &&
                        o.list.element
                            .querySelectorAll("li")
                            .forEach(function (l) {
                                l.removeEventListener(
                                    "focus",
                                    h._onSuggestionItemFocus,
                                ),
                                    l.removeEventListener(
                                        "keydown",
                                        h._onSuggestionItemKeyDown,
                                    );
                            }),
                        c.call(this),
                        h.options.useBrowserFocus &&
                            o.list.element.querySelectorAll("li").forEach(
                                function (l, g) {
                                    g === 0 && l.focus(),
        ...
        _onSuggestionItemKeydown(e) {
            ...
            if (t !== 9) {
                if (t === 13) {
                    e.preventDefault();
                    let r =
                        this._typeahead.list.element.querySelector(".active");
                    if (r) {
                        let n = r.getAttribute("data-index"),
                            i = this._typeahead.list.items[n];
                        i &&
                            (this._typeahead.value(i.original),
                            this._typeahead.list.hide());
                    }
                } else if (t === 38 || t === 40) {
                    let r = this._typeahead.list.element.querySelectorAll("li");
                    if (r.length > 0) {
                        if (t === 38)
                            ...
                            if (
                                (e.preventDefault(),
                                this._typeahead.list.active < r.length - 1)
                            )
                                this._typeahead.list.active++;
                            else return;
                        ...
                        let n = r[this._typeahead.list.active];
                        ...
                        function (e) {
                            ...
                            if (this.options.localGeocoderOnly) {
                                ...
                                this.geocoderService
                                    ...
                                    .then(
                                        function (n) {
                                            let i = n.body.features[0];
                                            if (i) {
                                                let s =
                                                    mr.transformFeatureToGeolocationText(
                                                        i,
                                                        this.options
                                                            .addressAccuracy,
                                                    );
        ...
        createIcon: function (e, t) {
            ...
            return (
                ...
                r.setAttribute("viewBox", "0 0 18 18"),
        ...
        _onKeyDown: function (e) {
            ...
            this._hideGeolocateButton(),
                !(
                    e.metaKey ||
                    [r, t, 37, 39, 13, 38, 40].indexOf(e.keyCode) !== -1
                ) &&
                    n.value.length >= this.options.minLength &&
                    this._geocode(n.value);
        },
        ...
        _onChange: function () {
            ...
            e &&
                JSON.stringify(e) !== this.lastSelected &&
                (this._hideClearButton(),
                this.options.flyTo && this._fly(e),
        ...
        _fly: function (e) {
            var t;
            if (e.properties && gr[e.properties.short_code])
                (t = M({}, this.options.flyTo)),
                    this._map &&
                        this._map.fitBounds(
                            gr[e.properties.short_code].bbox,
                            t,
                        );
            else if (e.bbox) {
                var r = e.bbox;
        ...
        _requestType: function (e, t) {
            ...
            return (
                e.localGeocoderOnly
                    ? (r = I.LOCAL)
                    : e.reverseGeocode && mr.REVERSE_GEOCODE_COORD_RGX.test(t)
                      ? (r = I.REVERSE)
                      : (r = I.FORWARD),
                r
            );
        ...
        _setupConfig: function (e, t) {
            let r = [
                ...
                n = /[\s,]+/;
            var i = this,
                s = r.reduce(function (u, a) {
                    if (i.options[a] === void 0 || i.options[a] === null)
                        return u;
                    ["countries", "types", "language"].indexOf(a) > -1
                        ? (u[a] = i.options[a].split(n))
                        : (u[a] = i.options[a]);
                    let c =
                        typeof i.options[a].longitude == "number" &&
                        typeof i.options[a].latitude == "number";
                    if (a === "proximity" && c) {
                        let d = i.options[a].longitude,
                            h = i.options[a].latitude;
                        u[a] = [d, h];
                    }
                    return u;
                }, {});
            switch (e) {
                case I.REVERSE:
                    {
                        var o = t.split(n).map(function (u) {
                            return parseFloat(u, 10);
                        });
                        i.options.flipCoordinates || o.reverse(),
                            s.types && s.types[0],
                            (s = M(s, { query: o, limit: 1 })),
                            [
                                "proximity",
                                "autocomplete",
                                "fuzzyMatch",
            ...
            return (s.session_token = this.eventManager.getSessionId()), s;
        },
        _geocode: function (e) {
            (this.inputString = e),
                this._showLoadingIcon(),
                this._eventEmitter.emit("loading", { query: e });
            let t = this._requestType(this.options, e),
                r = this._setupConfig(t, e);
            var n;
            switch (t) {
                case I.LOCAL:
                    n = Promise.resolve();
                    break;
                case I.FORWARD:
                    n = this.geocoderService.forwardGeocode(r).send();
                    break;
                case I.REVERSE:
                    n = this.geocoderService.reverseGeocode(r).send();
                    break;
            }
                            ...
                            this.options.filter &&
                                ...
                                u.features.length
                                    ? (this._showClearButton(),
                                      ...
                                      this._eventEmitter.emit("results", u),
                                      this._typeahead.update(u.features))
                                    : (this._hideClearButton(),
                                      this._hideAttribution(),
                    ...
                    .catch(
                        function (u) {
                            this._hideLoadingIcon(),
                                ...
                                (s.length && this.options.externalGeocoder)
                                    ? (this._showClearButton(),
                                      this._hideGeolocateButton(),
                                ...
                                this._eventEmitter.emit("error", { error: u });
                        }.bind(this),
                    ),
                n
            );
        ...
        clear: function (e) {
            this._clear(e),
                this._inputEl.focus(),
                this.options.useBrowserFocus && this._typeahead.list.hide();
        },
        ...
        _onQueryResult: function (e) {
            ...
            if (t.features.length) {
                var r = t.features[0];
                (this._typeahead.selected = r),
                    (this._inputEl.value = r.place_name),
                    this._onChange();
            }
        },
        ...
        setInput: function (e, t) {
            return (
                ...
                e.length >= this.options.minLength &&
                    (t ? this._geocode(e) : this._onChange()),
                this
            );
        },
        setProximity: function (e, t = !0) {
            return (
                (this.options.proximity = e),
                t && (this.options.trackProximity = !1),
                this
            );
        },
        ...
        setRenderFunction: function (e) {
            return (
                e && typeof e == "function" && (this._typeahead.render = e),
                this
            );
        },
        ...
        setPlaceholder: function (e) {
            return (
                (this.options.placeholder = e || this._getPlaceholderText()),
        ...
        _handleMarker: function (e) {
            if (this._map) {
                this._removeMarker();
                var t = { color: "#4668F2" },
                    r = M({}, t, this.options.marker);
                return (
                    (this.mapMarker = new this._mapboxgl.Marker(r)),
                    e.center
...
function fi(e, t, r = !1) {
    return {
        ...
        state: e,
        init() {
            (this.geocoder = new _r.default(t).on(
                "result",
                this.onResult.bind(this),
            )),
                this.geocoder.addTo(this.$root),
                (this.structured = typeof this.state != "string"),
                this.geocoder._inputEl &&
                    ((this.geocoder._inputEl.value = this.structured
                        ? (this.state.placeName ?? "")
                        : this.state),
                    (this.geocoder._inputEl.disabled = r));
        },
        onResult({ result: n }) {
            if (!this.structured) {
                this.state = n.place_name;
                return;
            }
            this.state = {
                address: n.place_name.split(",")[0],
                houseNumber: n.address,
                street: n.text,
                postcode: n.context.find((i) => i.id.startsWith("postcode"))
                    ?.text,
                place: n.context.find((i) => i.id.startsWith("place"))?.text,
                region: n.context.find((i) => i.id.startsWith("region"))?.text,
                country: n.context.find((i) => i.id.startsWith("country"))
                    ?.text,
