(() => {
        ...
        async fn(t) {
            ...
            let de = Y / 2 - ne / 2,
                ...
                j =
                    ...
                    xt(i) != null &&
                    v !== p &&
                    o.reference[S] / 2 - (v < l ? Q : me) - C[S] / 2 < 0,
                M = j ? (v < l ? v - l : v - h) : 0;
            return {
                [E]: O[E] + M,
                data: {
        ...
        if (o) {
            ...
            for (; C && n && E !== S; ) {
                let I = Dn(C),
                    ...
                    k =
                        $.left +
                        (C.clientLeft + parseFloat(A.paddingLeft)) * I.x,
    ...
    function Ta(e) {
        let { element: t, boundary: r, rootBoundary: n, strategy: i } = e,
            a = [
                ...(r === "clippingAncestors" ? Ca(t, this._c) : [].concat(r)),
                n,
            ],
            d = a[0],
            f = a.reduce(
    ...
    function co(e) {
        ...
        async function O(A) {
            if (A.startsWith("_x_async_") || (C(A), !a[A] || a[A].loaded))
                return;
            let k = await E(A);
                ...
                if (G) {
                    ...
                    fe === r(b) &&
                        ...
                        O(fe).position !== "static" &&
                            ((Pe = "scrollHeight"), (Ce = "scrollWidth"))),
                        (fe = fe),
                        P === V &&
                            ((Re = de),
                            (xe -= fe[Pe] - T.height),
                ...
                if (Ce) {
                    if (F || H) {
                        var Ue = fe === "y" ? V : Q,
                            ...
                            _ = s.modifiersData["arrow#persistent"]
            ...
            function Ge(c) {
                ...
                if (!(!F || !U)) {
                    var _e = x(P.padding, b),
                        ...
                        Le = G;
                    b.modifiersData[T] =
                        ((s = {}), (s[Le] = Ne), (s.centerOffset = Ne - Ce), s);
                }
            }
            function ce(c) {
                var s = c.state,
...
`,
            ...
            function fn(g, w) {
                ...
                return (
                    ...
                    ce.addEventListener("mouseleave", function (_) {
                        x.props.interactive &&
                            ...
                            (yt().addEventListener("mousemove", Ie), Ie(_));
                    }),
                    x
                );
                function Kt() {
                ...
                function U(_) {
                    if (
                        !(M.isTouch && (le || _.type === "mousedown")) &&
                        !(x.props.interactive && ce.contains(_.target))
                    ) {
                ...
                function He(_) {
                    var K =
                        Pe(_) || (x.props.trigger.indexOf("click") >= 0 && B);
                    if (!K) {
                ...
                function fe(_) {
                    (x.props.trigger.indexOf("focusin") < 0 &&
                        ...
                        (x.props.interactive &&
                            _.relatedTarget &&
                            ce.contains(_.relatedTarget)) ||
                        Ue(_);
                }
                function Pe(_) {
                    return M.isTouch
                        ? Jt() !== _.type.indexOf("touch") >= 0
                        : !1;
                }
                function Ce() {
                    Ne();
                ...
                function Le() {
                    var _ = x.props.appendTo,
                        K,
                        te = lt();
                    (x.props.interactive && _ === Ze.appendTo) || _ === "parent"
                        ? (K = te.parentNode)
                        : (K = O(_, [te])),
                                ...
                                (S.__livewire = t),
                                    window.Alpine.morph(m, S, {
                                        updating: (C, I, $, A) => {
                                            if (!a(C)) {
                                                if (
                                                    (C.__livewire_replace ===
                                                        !0 &&
                                                        (C.innerHTML =
                                                            I.innerHTML),
                                                    C.__livewire_replace_self ===
                                                        !0)
                                                )
                                                    return (
                                                        (C.outerHTML =
