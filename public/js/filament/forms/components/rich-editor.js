            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type
                        ...
                        : sa(l.type, e.type)) && (s = l.addToSet(s));
...
var re;
for (re = 65; re <= 90; re++)
    (ht[re] = String.fromCharCode(re + 32)), (qr[re] = String.fromCharCode(re));
var re;
    ...
    let r = Ru(t),
        ...
        l = Object.fromEntries(
            o.map((c) => {
                ...
                m &&
                    (h.toDOM = (y) => m({ node: y, HTMLAttributes: to(y, u) }));
        ...
        a = Object.fromEntries(
            i.map((c) => {
                ...
                return (
                    m &&
                        (h.toDOM = (g) =>
                            m({ mark: g, HTMLAttributes: to(g, u) })),
                    [c.name, h]
                );
            }),
        );
...
function Us(t, e, n) {
    ...
    for (; a < t.parent.childCount && ku([...t.parent.child(a).marks], e, n); )
...
var O0 = z.create({
        ...
        addInputRules() {
            return [
                fo({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type }),
            ];
        },
    }),
    Nd = O0;
    ...
    return new N({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let a = Xo(l, { defaultProtocol: t.defaultProtocol }).find(
                                ...
                                ? () => {
                                      ...
                                      let { decorationId: zh } =
                                              (wr = this.key) == null
                                                  ? void 0
                                                  : wr.getState(e.state),
                                          Zl = x.dom.querySelector(
                                              `[data-decoration-id="${zh}"]`,
                                          );
                                      return (
                                          Zl?.getBoundingClientRect() || null
                                      );
                                  }
                                : null,
                        }),
...
function $l(t, e) {
    ...
    return (
        e ? e.doc != t.doc && Of(e.doc, t.doc, 0, r) : t.doc.descendants(r), n
    );
}
function Wb(t, e, n, r) {
    let o = ee.get(e);
    ...
    let i = new N({
        ...
        state: {
            init(s, l) {
                ...
                return (
                    r && u && (u[d] = (f, h) => new r(f, n, h)), new ix(-1, !1)
                );
            },
            apply(s, l) {
                return l.apply(s);
...
var sw = class {
        ...
        updatePosition() {
            let { selection: t } = this.editor.state,
                e = {
                    getBoundingClientRect: () => $u(this.view, t.from, t.to),
                };
            if (t instanceof K) {
